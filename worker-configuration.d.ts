/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 37c385cfcf18f437dd5ee9ae3aeb51ea)
// Runtime types generated with workerd@1.20250906.0 2025-09-06 
declare namespace Cloudflare {
	interface Env {
		DATABASE_URL: string;
		DP_ENV: string;
		DP_MERCHANT_ID: string;
		DP_MERCHANT_API_KEY: string;
	}
}
